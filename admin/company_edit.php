...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Actualizar Datos Empresa</a></li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2">Actualizar Datos Empresa</h1>
    ...
    <div style="width: 60%; margin-left: 20%; background-color: #A0A7A8;">
        ...
        <form action="" method="POST" style="margin: 3%; padding:3%;" name="customer_form" id="customer_form">
            ...
            <div class="form-group">
                ...
                <input type="company" name="company" id="company" value="<?php echo $company_name; ?>" class="form-control" placeholder="Introduzca el nombre de la empresa">
            </div>
            <div class="form-group">
