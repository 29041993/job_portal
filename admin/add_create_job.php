            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Agregar Empleo</a></li>
                    </ol>
                </nav>
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    <h1 class="h2">Agregar Empleo</h1>
                ...
                <!-- Formulario -->
                    ...
                    <div id="msg"></div>
                        <div class="form-group">
                            ...
                            <input type="text" name="job_title" id="job_title" class="form-control" placeholder="Introduzca el Empleo">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="Customer Username">Palabra clave</label>
                            <input type="text" class="form-control" name="keyword" id="keyword" placeholder="Introducir palabra clave">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="city" id="cityId" class="cities form-control" onkeyup="capitalizarPrimeraLetra()" placeholder="Introduzca la Ciudad">
                        </div>
                        <div class="form-group">
