            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Agregar Categoria</a></li>
                    </ol>
                </nav>
                ...
                <!-- Formulario -->
                    ...
                    <div id="msg"></div>
                        <div class="form-group">
                            ...
                            <input type="text" name="category" id="category" class="form-control" placeholder="Introduzca la categoria del trabajo">
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function(){
            $("#submit").click(function(){
                ...
                var category = $("#category").val();
                    ...
                    if (category == '') {
                        alert("por favor, introduzca la categoria del trabajo");
                        return false;
                    }
