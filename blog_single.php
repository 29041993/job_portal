        ...
        <ul class="navbar-nav ml-auto">
          ...
          if (isset($_SESSION['email']) == true){ ?>
            <li class="nav-item cta mr-md-2">
              <a href="job-post.php" class="nav-link"><?php echo $_SESSION['email']; ?></a>
            </li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 ftco-animate">
          ...
          <h6><?php echo $country; ?>, <?php echo $state; ?>, <?php echo $city; ?></h6>
          <h4><?php echo $des; ?></h4>

          <form action="apply_job.php" method="POST" id="jobPortal" name="jobPortal" enctype="multipart/form-data" style="border: 1px solid gray; border-radius: 2px;">
          <div style="padding: 2%;">
          <input type="hidden" name="applicant" id="applicant" value="<?php echo $_SESSION['email']; ?>">
          <input type="hidden" name="id_job" id="id_job" value="<?php echo $id_job; ?>">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <input type="date" class="form-control" name="dob" id="dob" placeholder="Fecha de Nacimiento">
              </div>
              <div class="col-sm-6">
                <label for="">Subir Hoja de Vida</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <input type="number" class="form-control" name="number" id="number" placeholder="Número de Teléfono">
              </div>
              <div class="col-sm-6">
            ...
            <div class="form-group" >
              <br>
              <input type="submit" name="submit" id="submit" value="Enviar" class=" btn btn-primary btn-block" >    <!-- este puede ser un boton con realse "cta cta-colored" -->
            </div>
        </div>
          </form>
