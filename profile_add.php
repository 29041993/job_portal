    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
        ...
        <main role="main" class="inner cover">
            ...
            if (!empty($sql_check)) {
                ...
                if ($query) {
                    echo "<h1>Perfil actualizado</h1>";
                } else {
                    echo "<h1>Algún error, Por favor, Inténtelo de nuevo</h1>";
                }
            } else {
                ...
                if ($query) {
                    echo "<h1>Perfil añadido con éxito</h1>";
                } else {
                    echo "<h1>Algún error, Por favor, Inténtelo de nuevo</h1>";
                }
            }
            ...
            <p class="lead">
                <a href="http://localhost/job_portal/my_profile.php" class="btn btn-lg btn-secondary">Volver</a>
            </p>
        </main>
